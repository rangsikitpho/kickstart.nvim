...
-- Split navigation is handled by Navigator.nvim (lua/custom/plugins/tmux-navigator.lua)
-- which also supports navigating across tmux panes with <C-h/j/k/l>
...
require('lazy').setup({
  ...
  { -- Snacks.nvim: picker, explorer, notifier, and more
    'folke/snacks.nvim',
    priority = 1000,
    lazy = false,
    ---@type snacks.Config
